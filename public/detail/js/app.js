...
また、CSS学習中にスタイルを崩してしまった経験から、CSS設計（FLOCSS）を学び、全体の影響範囲を考えながらコーディングすることを心がけました。
...
Vue.jsに関しては、後述するLaravelと非同期通信（axios）を用いて、開発することができます。
...
また、「var, let, constの違い」、「stop.propagationがどういう挙動をするのか」など、学習中に疑問があればその都度調べ、理解を深めるためにサンプルコードで動作を確かめながら、学習を進めていきました。`
      }, {
        title: 'バックエンド',
        learningContents: ['PHP', 'Laravel', 'SQL'],
        currentLevel: `フロントエンドと同様にデバッグ（ブレークポイント）を利用して勉強・開発を行いました。
Laravelでは、基本的な機能（Vue.jsとの連携・SQLによるデータ取得・基本的なテストコードなど）の実装をすることができます。
SQLに関しては、JOIN（RIGHT JOIN, LEFT JOIN）、サブクエリを用いて柔軟にデータを表示させることを学習しました。`,
        consciousness: `バックエンドを理解するために、PHPフルスクラッチでコードを書く練習・オブジェクト指向の学習、全体的なベースとなるネットワーク・サーバー（Cookie, Sessionの違いなど）の学習などを最初に行いました。
...
はじめにプロトタイプを考え、デザインの構成を考えてから制作するようにしています。そうすることにより、デザインに迷うことなく制作でき、効率的に作業を進めることができています。

【タッチタイピング】
キーボードを見ずにタイピングができ、ショートカットキーを意識して利用することにより、効率を上げる工夫をしています。`,
        consciousness: `【Adobe XD】
構成を考えるときに、HTML,CSSで実装する場合のことを考え、プロトタイプに落とし込んでいきました。
あくまで、プロトタイプがメインではなく、制作することがメインですので、プロトタイプが8割完成したらそのまま制作に移り、制作しながらデザインを考える方法で学習を進めていきました。`
      }, {
        title: '現在勉強中',
        learningContents: ['Linux', 'Git'],
        currentLevel: `Linux・Gitは、基本的な操作を行うことができます。実際に使用するとなるとまだまだ不明な点や不安定な部分があるので、今後もスムーズに利用していけるようにさらに学習が必要です

【Git】
Gitは基本的なコマンドに加え、チーム開発をすることを意識して、git-flow,GitHub Flowの基本的な流れについて学習をしました。実務によってルールが異なっているとの情報がありましたので、今後も柔軟に継続して学んでいきたいと思っています。
`,
        consciousness: `実際に制作時に使用していく中で、わからない部分が出てきたら、その都度調べながら利用していました。

Linux・Gitに関しては、今後も使用され続ける重要な技術ですので、積極的に学習していきたいと思います。`
      }]
    };
  }
...
module.exports = JSON.parse("[{\"id\":1,\"title\":\"フリマアプリ (PHPによるフルクラッチ)\",\"image\":\"fleamarket.png\",\"createDate\":\"2020/05/19\",\"design\":\"未対応\",\"learning\":[\"HTML\",\"CSS\",\"jQuery\",\"PHP (フルスクラッチ)\"],\"detail\":\"https://qiita.com/mugicha_88361/private/d58e5e6e18c428c26e20\",\"look\":\"https://created-portfolio.com/fleamarket\",\"github\":\"https://github.com/hotarika/01_fleamarket\",\"section\":\"portfolio\",\"new\":false},{\"id\":2,\"title\":\"オブジェクト指向の学習\",\"image\":\"objective.png\",\"createDate\":\"2020/05/25\",\"design\":\"未対応\",\"learning\":[\"HTML\",\"CSS\",\"PHP\"],\"detail\":\"https://github.com/hotarika/objective#readme\",\"look\":\"https://created-portfolio.com/objective\",\"github\":\"https://github.com/hotarika/objective\",\"section\":\"other\",\"new\":false},{\"id\":3,\"title\":\"WordPressの学習（歯医者HP）\",\"image\":\"wordpress.png\",\"createDate\":\"2020/06/05\",\"design\":\"未対応\",\"learning\":[\"HTML\",\"CSS\",\"WordPress\"],\"detail\":\"https://github.com/hotarika/wordpress#readme\",\"look\":\"https://created-portfolio.com/dentist\",\"github\":\"https://github.com/hotarika/wordpress\",\"section\":\"other\",\"new\":false},{\"id\":4,\"title\":\"Sass(SCSS)・レスポンシブの学習\",\"image\":\"sass.png\",\"createDate\":\"2020/06/29\",\"design\":\"◯\",\"learning\":[\"HTML\",\"SCSS\"],\"detail\":\"https://github.com/hotarika/sass#readme\",\"look\":\"https://created-portfolio.com/sass\",\"github\":\"https://github.com/hotarika/sass\",\"section\":\"other\",\"new\":false},{\"id\":5,\"title\":\"簡易SNSアプリ\",\"image\":\"sns.png\",\"createDate\":\"2020/09/15\",\"design\":\"未対応\",\"learning\":[\"Vue.js(非同期処理含む)\",\"Laravel\"],\"detail\":\"https://github.com/hotarika/sns#readme\",\"look\":\"https://created-portfolio.com/sns\",\"github\":\"https://github.com/hotarika/sns\",\"section\":\"other\",\"new\":false},{\"id\":6,\"title\":\"TODOアプリの制作\",\"image\":\"todo.png\",\"createDate\":\"2020/10/09\",\"design\":\"未対応\",\"learning\":[\"Vue.js(非同期処理含む)\",\"Laravel\"],\"detail\":\"https://github.com/hotarika/todo#readme\",\"look\":\"https://created-portfolio.com/todo\",\"github\":\"https://github.com/hotarika/todo\",\"section\":\"other\",\"new\":false},{\"id\":7,\"title\":\"ポートフォリオのまとめサイト\",\"image\":\"portfoliosite.png\",\"createDate\":\"2021/01/04\",\"design\":\"◯\",\"learning\":[\"HTML\",\"SCSS\",\"Bootstrap (一部機能)\",\"Vue.js (コンポーネント化)\",\"webpack\"],\"detail\":\"https://github.com/hotarika/portfolio#readme\",\"look\":\"https://created-portfolio.com/\",\"github\":\"https://github.com/hotarika/portfolio\",\"section\":\"other\",\"new\":false},{\"id\":8,\"title\":\"書籍管理アプリ（HONDANA）\",\"image\":\"hondana.png\",\"createDate\":\"2021/01/30\",\"design\":\"◯\",\"learning\":[\"HTML\",\"SCSS\",\"Bootstrap (一部機能)\",\"JavaScript\",\"Vue.js\",\"Laravel\"],\"detail\":\"https://qiita.com/mugicha_88361/private/535edf69a201692fb8e2\",\"look\":\"https://created-portfolio.com/hondana/\",\"github\":\"https://github.com/hotarika/hondana\",\"section\":\"portfolio\",\"new\":true}]");
